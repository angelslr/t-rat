...
var chartResearchers = new Chart(ctx, {
	...
	data: {
		labels: ['-'],
		datasets: [{
			label: 'Tests performed by researchers',
			data: [0],
			backgroundColor: backColor,
			borderColor: borColor,
			borderWidth: 1
	...
	options: {
		scales: {
			yAxes: [{
				...
				scaleLabel: {
					display: true,
					labelString: 'Number of tests performed'
				}
			}]
		}
	}
	...
	options: {
		scales: {
			yAxes: [{
				scaleLabel: {
					display: true,
					labelString: 'Amount of movement'
				}
			}]
		}
	}
